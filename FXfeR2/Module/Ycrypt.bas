...
Private Const sEncTab As String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789._"

Private Function Mac64(sInput As String) As String
...
Private Function HashString(ByVal HashStr As String) As String
Dim strTemp As String, strReturn As String, i As Long
For i = 1 To Len(HashStr) Step 2
strTemp = Chr$(Val("&H" & Mid$(HashStr, i, 2)))
...
Private Function MD5Hash(StrToMD5 As String) As String
Dim bytBuffer() As Byte
bytBuffer = MD5StringArray(StrToMD5)
MD5Start
MD564Split Len(StrToMD5), bytBuffer
MD5Finish
MD5Hash = HashString(MD5Value)
End Function
...
Public Function YMSG15(yCrumb As String, yChallenge As String) As String
On Error Resume Next
Dim TmpAuth As String
TmpAuth = yCrumb & yChallenge
TmpAuth = MD5Hash(TmpAuth)
YMSG15 = Mac64(TmpAuth)
End Function
